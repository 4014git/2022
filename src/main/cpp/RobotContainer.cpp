...
{
    // frc2::JoystickButton(&m_driverController, OIConstants::driverControllerChangeSquareInputs)
    //     .WhenPressed(m_changeSquareInputPressed)
    //     .WhenReleased(m_changeSquareInputReleased);
    ...
    // frc2::JoystickButton(&m_operatorController, OIConstants::operatorControllerClimberByJoystickButton)
    //     .WhileHeld(m_ClimberByJoystick);
}
